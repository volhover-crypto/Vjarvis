...
"""
Временный скрипт для восстановления доступа к Google Calendar через OOB (out-of-band) OAuth 2.0.
...
def main():
    print("🔐 Restoring Google Calendar Access (OOB Flow)")
    ...
    if os.path.exists(TOKEN_PATH):
        ...
        if answer != 'y':
            ...
            print("🗑️  Removing existing token...")

    # Настраиваем flow с OOB redirect URI
    ...
    print("   4. After successful sign-in, you will see a page with an authorization code")
    print("   5. Copy the entire code from the page")
    print("   6. Paste it here and press Enter")
    print()
    print("⏳ Waiting for authorization code...")

    try:
        # Ждём ввода кода от пользователя
    ...
    print(f"🔑 Received authorization code (first 10 chars): {auth_code[:10]}...")

...
REDIRECT_URI = 'http://localhost:8080/'  # Локальный redirect URI
...
def main():
    ...
    print("   4. After successful sign-in, you will see a success message in the browser")
    print("   5. Return here and wait for my next message")
    print()

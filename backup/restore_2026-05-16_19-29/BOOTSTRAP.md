...
- **RAM 1.8 ГБ** — полная генерация эмбеддингов GBrain (1558 чанков) не помещается в память. Swap увеличен до 2.9Gi.
- **GBrain embed** — требует OpenAI API key. Без него семантический поиск невозможен.
